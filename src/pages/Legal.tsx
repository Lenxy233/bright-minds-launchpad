...
const Legal = () => {
  ...
  // Determine which sections to show based on the current path and hash
  const showPrivacyPolicy = !location.hash || location.hash === '#privacy-policy' || location.pathname === '/privacy-policy';
  const showDataProtection = !location.hash || location.hash === '#data-protection-policy' || location.pathname === '/data-protection-policy';
  const showTermsConditions = !location.hash || location.hash === '#terms-and-conditions' || location.pathname === '/terms-and-conditions';
  const showEarningsDisclaimer = location.hash === '#earnings-disclaimer' || location.pathname === '/earnings-disclaimer';
  const showRefundPolicy = location.hash === '#refund-policy' || location.pathname === '/refund-policy';
